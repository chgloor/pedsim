...
int main(int argc, char *argv[]) {
	...
	for (int i = 0; i<nagents; i++) { 
		...
		a->destinations.push(w11);
		a->destinations.push(w1);
		a->destinations.push(w11);
		if (i%2 == 0) { a->destinations.push(wsb); } else {a->destinations.push(wst); }
		a->destinations.push(w22);
		a->destinations.push(w2);
		a->destinations.push(w23);
		a->destinations.push(wr2);
		a->destinations.push(wr1);
		a->destinations.push(w3);
		if (i%2 == 0) { a->destinations.push(wstr); } else {a->destinations.push(wstl); }
		if (i%2 == 0) { a->destinations.push(wsr); } else {a->destinations.push(wsl); }
		a->destinations.push(w4);
		if (i%2 == 0) { a->destinations.push(wsr); } else {a->destinations.push(wsl); }
		if (i%2 == 0) { a->destinations.push(wstr); } else {a->destinations.push(wstl); }
		a->destinations.push(w3);
		a->destinations.push(wr1);
